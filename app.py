...
#ETAPA 01 - CARREGAMENTO DO MODELO PARA O NOSSO FRONT-END
...
#ETAPA 02: CONFIGURAÇÃO DA INTERFACE DO USUÁRIO(STREAMLIT)
...
if pipeline_modelo is not None:
    #Utilizar um furmulário para agrupar as entradas e o botão
    with st.form("Formulario_previsao"):
        ...
        with col1:
            ...
            media_trabalhos = st.slider("Media dos trabalhos (0 a10)", min_value=0.0, max_value=10.0, value=5.0, step=0.5)
        ...
        with col2:
            ...
            acesso_mes = st.number_input("Média de acessos à plataforma (por mês)", min_value=0, max_value=100, value=10, step=1)
    ...
    if submitted:
        ...
        try:
            ...
            st.error("Verique se os nomes das colunas correspondem aos nomes das colunas utilizados no treino")
